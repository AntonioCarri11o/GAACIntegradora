    ...
    <div class="container-md card" style="height: 50%;">
        <div class="cbody">
            ...
            <div class="d-grid gap-2 bottombtn">
                ...
                <div class="row">
                    <div class="col"><a href="/HTML/Estudiantes/EstudiantesRegistro.html" class="btn btn-primary width100" >Estudiante</a></div>
                    <div class="col"><a href="/HTML/Estudiantes/EstudiantesRegistro.html" class="btn btn-primary width100" >Docente</a></div>
                </div>
                <a href="/HTML/Docentes/DocenteInicioSesion.html" class="btn btn-primary" >Iniciar sesión</a>
